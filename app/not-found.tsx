...
export default function NotFound() {
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-brand-dark p-6 text-center text-brand-cream pt-24">
            ...
            <Link
                href="/"
                className="rounded-full bg-brand-gold px-8 py-3 text-sm font-bold uppercase tracking-widest text-brand-dark transition-all hover:bg-white hover:scale-105"
            >
                Return Home
            </Link>
        </div>
